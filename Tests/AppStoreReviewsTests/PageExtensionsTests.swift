...
final class PageExtensionsTests: XCTestCase {
    ...
    func testInvalidLinkUrlsReturnNil() {
        ...
        XCTAssertNil(Page(URL(string: "https://itunes.apple.com/fr/rss/customerreviews/page=2/id=1/sortby=mostrecent/xml?l=en&urlDesc=/customerreviews/page=abc/id=1/sortby=mostrecent/json")!))
        XCTAssertNil(Page(URL(string: "https://itunes.apple.com/fr/rss/customerreviews/page=2/id=1/sortby=mostrecent/xml?l=en&urlDesc=/customerreviews/page=1/id=abc/sortby=mostrecent/json")!))
        XCTAssertNil(Page(URL(string: "https://itunes.apple.com/fr/rss/customerreviews/page=2/id=1/sortby=mostrecent/xml?l=en&urlDesc=/customerreviews/page=-1/id=1/sortby=mostrecent/json")!))
        XCTAssertNil(Page(URL(string: "https://itunes.apple.com/fr/rss/customerreviews/page=2/id=1/sortby=mostrecent/xml?l=en&urlDesc=/customerreviews/page=1/id=0/sortby=mostrecent/json")!))
    }
    ...
    func testValidLinkUrlReturnsPage() {
        ...
        let url2 = URL(string: "https://itunes.apple.com/fr/rss/customerreviews/page=2/id=1/sortby=mostrecent/xml?l=en&urlDesc=/customerreviews/page=2/id=1/sortby=mostrecent/json")!
        let url3 = URL(string: "https://itunes.apple.com/cn/rss/customerreviews/page=10/id=497799835/sortby=mostrecent/xml?l=en&urlDesc=/customerreviews/page=10/id=497799835/sortby=mostrecent/json")!
        ...
        XCTAssertEqual(Page(url4), try Page(appID: 497799835, territory: .CN, page: 10))
    }
